...
<section id="plataforma-site-blindado" class="project-featured-section text-color-inverse">
  <div class="container">
    <article class="project-featured">
      <!-- Coluna Esquerda: Imagem -->
      <div class="project-featured-image-column">
        <!-- <img src="/assets/images/portfolio/plataforma-site-blindado/splash-screen-cover.jpg" alt="Plataforma Site Blindado"> -->
      </div>

      <!-- Coluna Direita: Conteúdo com Efeito Sticky -->
      <div class="content-sticky-wrapper">
        <div class="content-fixed" id="featured-text-2">
          <div class="project-featured-content-column">
            <header>
              <h2>Plataforma Site Blindado</h2>
            </header>
