        ...
        <div class="content-fixed" id="featured-text">
          <div class="project-featured-content-column">
            <header>
              ...
              <p class="project-subtitle text-color-inverse">Plataforma de mobilização social durante a pandemia</p>
            </header>
            ...
            <div class="project-cta">
              ...
              <a href="/portfolio/sesi-cidadania-contra-fome" class="btn-hilght">
